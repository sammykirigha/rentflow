...
import { ChevronLeft, ChevronRight, Filter, MoreHorizontal, Search, UserCheck, UserX } from "lucide-react";
...
export function UsersTable({}: UsersTableProps) {
    ...
    const updateUserStatusMutation = useMutation({
        ...
        onSuccess: (updatedUser) => {
            ...
            toast.success(
                `User ${updatedUser.firstName} ${updatedUser.lastName} has been ${
                    updatedUser.status === "suspended" ? "deactivated" : "activated"
                } successfully`
            );
